...
export async function processPdfForRAG(db: Firestore, fileBuffer: Buffer, filename: string) {
    console.log(`[RAG] Extraindo texto de: ${filename}`);
    ...
    console.log(`[RAG] Arquivo ${filename} dividido em ${chunks.length} partes. Gerando embeddings...`);
    ...
    console.log(`[RAG] Concluído o arquivo: ${filename}`);
}
